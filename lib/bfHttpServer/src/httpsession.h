/**
  ...
  @version $Id: httpsession.h 916 2010-10-24 08:55:32Z stefan $
*/
...
public:
    ...
    /**
      ...
      Otherwise it is a null session. Null sessions cannot store data.
     */
    ...
    */
    ...
    /**
      Null sessions cannot store data. This method is thread safe.
    */
    bool isNull() const;
