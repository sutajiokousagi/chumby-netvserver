/**
  ...
  @version $Id: logger.h 902 2010-10-19 09:01:12Z stefan $
*/
...
/**
  ...
  <p>
  A backtrace buffer may be used to provide detailed debug information
  when an error occurs, while keeping the logfile clean as long no error
  occurs.
  <p>
  ...
  because logging to the console is evil.
*/
